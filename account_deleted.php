...
<head>
    ...
    <title>Account Deleted - KaamBuddy</title>
...
<body>
    ...
    <footer>
        <div class="container">
            ...
            <div class="copyright">
                <p>&copy; <?php echo date('Y'); ?> KaamChaahiye. All rights reserved.</p>
            </div>
        </div>
    </footer>
</body>
